...
//uint8_t dma_buf[100000];
//uint8_t buffer_out[100000]; // 250000 works. Here are "global variables" which are not on stack or heap. Always allocated variables.
...
int main(void)
{
  ...
  //uint8_t buffer[250000] = {0}; // Crashes when buffer is 300KB, 250KBytes
  /* USER CODE END 2 */
